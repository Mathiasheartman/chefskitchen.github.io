  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 m-auto bg-white px-7 py-2 lg:max-w-[1440px]">
      <div className="flex items-start justify-between pt-1">
        ...
        >
          <ul className="flex flex-col gap-4 px-9 pt-2 pb-5 text-sm text-gray-700 sm:flex-row sm:gap-5 sm:text-gray-400 md:text-lg">
            <li
        ...
        <p className="top-18 right-10 flex cursor-pointer items-center text-xl">
          <img className="h-4 md:h-8" src="/call.png" alt="call" />{" "}
        ...
        >
          <p
            className={` ${show ? "menuFirst" : ""} h-0.5 w-5 rounded-full bg-black`}
          ></p>
          <p
            className={`${show ? "menuMid" : ""} h-0.5 w-5 rounded-full bg-black`}
          ></p>
          <p
            className={`${show ? "menuLast" : ""} h-0.5 w-5 rounded-full bg-black`}
          ></p>
        </button>
      </div>
    </header>
