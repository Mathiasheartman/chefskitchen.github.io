  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 m-auto bg-white px-7 py-3 lg:max-w-[1440px]">
      <div className="flex items-center justify-between pt-1 pb-2">
        ...
        <nav
          className={`absolute top-12 right-0 left-0 ${show ? "" : "hidden"} nav rounded-bl-lg bg-white sm:static`}
        >
          <ul className="flex flex-col gap-8 px-13 pt-5 pb-5 text-xl text-gray-700 sm:flex-row sm:gap-5 sm:px-0 sm:text-gray-700 md:text-lg">
            <li
